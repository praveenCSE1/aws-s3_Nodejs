...
const addNamedModule = (j, source, options) => {
    ...
    const v2RequireDeclarations = source.find(j.VariableDeclaration).filter((variableDeclaration) => variableDeclaration.value.declarations.some(
    ...
    (declaration) => {
        ...
        if (init.type === "CallExpression") {
            ...
            if (typeof args[0].value !== "string")
                return false;
            if (!args[0].value.startsWith(config_1.PACKAGE_NAME))
                return false;
            return true;
        }
        ...
        if (init.type === "MemberExpression") {
            ...
            if (!config_1.STRING_LITERAL_TYPE_LIST.includes(args[0].type))
                return true;
            if (args[0].value !== config_1.PACKAGE_NAME)
                return false;
            return true;
        }
        return false;
