    ...
    for (const getNames of [getNamesFromVariableDeclarator, getNamesFromAssignmentPattern]) {
        if (v2GlobalName) {
            ...
            if (v2ClientName === config_1.DYNAMODB) {
                namesFromGlobalModule.push(...getNames(j, source, (0, utils_1.getClientNewExpression)({ v2GlobalName, v2ClientName: config_1.DYNAMODB_DOCUMENT_CLIENT })));
            }
        }
        namesFromServiceModule.push(...getNames(j, source, (0, utils_1.getClientNewExpression)({ v2ClientLocalName })));
        if (v2ClientName === config_1.DYNAMODB) {
            namesFromServiceModule.push(...getNames(j, source, (0, utils_1.getClientNewExpression)({ v2ClientLocalName: `${v2ClientLocalName}.${config_1.DOCUMENT_CLIENT}` })));
        }
    }
