...
exports.getHelpParagraph = void 0;
const getTransformDescription_1 = require("./getTransformDescription");
const separator = "-".repeat(95);
const getHelpParagraph = (transforms) => `${separator}
...
${transforms.map((transform) => (0, getTransformDescription_1.getTransformDescription)(transform).join("\n"))}

Example: npx aws-sdk-js-codemod@latest -t v2-to-v3 example.js

${separator}\n\n`;
exports.getHelpParagraph = getHelpParagraph;
